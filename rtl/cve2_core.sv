...
`endif
  ...
  if (RV32VX) begin : gen_dmem_arbiter
    cve2_dmem_switch #(
      ...
      .vrf_data_addr_i(agu_vrf_mem_addr),
  ...
  if (RV32VX) begin : gen_asserts_with_vx
    assign outstanding_load_id  = id_stage_i.instr_executing & id_stage_i.lsu_req_dec & ~id_stage_i.lsu_we  |
                                  (id_stage_i.instr_executing & ~id_stage_i.vrf_we_id_o & vrf_memory_op | id_stage_i.vrf_req_o);
    assign outstanding_store_id = id_stage_i.instr_executing & id_stage_i.lsu_req_dec & id_stage_i.lsu_we | 
                                  (id_stage_i.instr_executing & id_stage_i.vrf_we_id_o & vrf_memory_op | id_stage_i.vrf_req_o);
  end else begin : gen_asserts_no_vx
